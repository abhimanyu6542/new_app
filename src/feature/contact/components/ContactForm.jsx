...
const ContactForm = () => {
  ...
  return (
    <>
      <section className="bg-white py-20 lg:py-[120px] overflow-hidden block z-10">
        <div className="container mx-2">
          <div className="flex md:ml-28 flex-wrap lg:justify-between">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">snag@snagcart.io</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form ref={form} onSubmit={handleSubmit(onSubmit)}>
                  <div className="mb-6">
                    ...
                    />
                    <p className="font-medium text-rose-600 text-start">
                  ...
                  <div className="mb-6">
                    <input
                      ...
                      className="border-[f0f0f0] w-full rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
                    />
                    <p className="font-medium text-rose-600 text-start">{errors.email?.message}</p>
                  </div>
                  <div className="mb-6">
                    <input
                      type="number"
