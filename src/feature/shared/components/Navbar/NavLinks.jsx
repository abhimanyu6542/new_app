        ...
        links.map((link) => (
          <div key={link.name}>
            <div key={link.name} className="px-3 text-left md:cursor-pointer group ">
              <div
                className="flex items-center justify-between py-2 pr-5 font-normal lg:py-7 md:pr-0 group"
                onClick={() => {
              ...
              >
                {link.submenu ? (
                  <>
                    <h5 className="hover:text-blue-600 text-[#323B4B] text-base font-medium font-rubik">
                      {link.name}
                    </h5>
                  ...
                  <Link
                    className="mt-1 hover:text-blue-600 text-[#323B4B] text-base font-medium font-rubik"
                    to={link.link}
                  >
                    {link.name}
                  </Link>
                  ...
                  <div
                    className={
                      link.sublinks.length > 5
                        ? 'absolute  w-[700px] transition-all shadow-xl rounded-xl duration-300 -mt-1 border-t-4 border-t-navItemHover top-20 hidden group-hover:lg:block hover:lg:block'
                        : 'absolute  w-80 transition-all shadow-xl rounded-xl duration-300 -mt-1 border-t-4 border-t-navItemHover top-20 hidden group-hover:lg:block hover:lg:block'
                    }
                  >
