      ...
      <div className="flex flex-col items-center justify-center w-full h-full text-white bg-transparent border-0 rounded-l-lg">
        <div className="pb-10 mb-10 border-b-2 border-white">
          ...
          <p className="text-sm font-semibold ">
            Take a comprehensive walkthrough of the features and functionalities that Yelo provides,
            and learn how you can launch and grow your hyperlocal business.
          </p>
        </div>
        ...
        <div className="w-full">
          ...
          <div className="flex items-center justify-between w-full">
            <img src="" alt="sponsers" className="w-20" />
            <img src="" alt="sponsers" className="w-20" />
            <img src="" alt="sponsers" className="w-20" />
            <img src="" alt="sponsers" className="w-20" />
          </div>
