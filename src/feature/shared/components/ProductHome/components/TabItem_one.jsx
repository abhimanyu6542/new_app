...
const TabItem_one = ({ data }) => {
  const { headings, paras, lists, image_one } = data.tabItem_one;
  return (
    <div className="sm:px-14 mb-3 flex flex-col-reverse sm:flex-row items-center">
      ...
      <img className="sm:w-7/12 w-11/12" src={`${IMAGE_BASE_URL + image_one}`} />
    </div>
  );
};

export default TabItem_one;
